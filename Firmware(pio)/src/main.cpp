...
void loop()
{
  ...
  {
    gpsstring1 = Serial1.readStringUntil('\n');
    //LOG_PORT.println(gpsstring1);
    gpsstring2 = Serial1.readStringUntil('\n');
    //LOG_PORT.println(gpsstring2);
  }
...
void logIMUData(void)
{
  ...
  if ( sdCardPresent && enableSDLogging)
  {
    ...
    logFileBuffer += gpsstring1;
    logFileBuffer += gpsstring2;
  }
  else
  {
